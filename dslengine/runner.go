...
func init() {
	dslPackages = map[string]bool{
		"github.com/manelmontilla/goa/":            true,
		"github.com/manelmontilla/goa/middleware/": true,
		"github.com/manelmontilla/goa/encoding/":   true,
		"github.com/manelmontilla/goa/logging/":    true,
	}
}
