...
DEPEND=\
	...
	github.com/manelmontilla/goa-cellar \
	github.com/manelmontilla/goa.design/tools/mdc \
...
docs:
	...
	@git clone https://github.com/manelmontilla/goa.design
	@rm -rf goa.design/content/reference goa.design/public
	@mdc --exclude goa.design github.com/manelmontilla/goa goa.design/content/reference
	@cd goa.design && hugo
	@rm -rf public
