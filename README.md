...
[![License](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/manelmontilla/goa/blob/master/LICENSE)
[![Godoc](https://godoc.org/github.com/manelmontilla/goa?status.svg)](https://godoc.org/gopkg.in/goadesign/goa.v1)
...
go get github.com/manelmontilla/goa/...@v1
```
...
```bash
cd $GOPATH/src
mkdir -p github.com/manelmontilla
cd github.com/manelmontilla
git clone https://github.com/manelmontilla/goa
cd goa; git checkout v1
go get -v github.com/manelmontilla/goa/...
```
...
For example displaying the docs for `github.com/manelmontilla/goa-cellar/design` is
done by browsing to:
...
The [examples](https://github.com/manelmontilla/examples) repo contains simple examples illustrating
basic concepts.

The [goa-cellar](https://github.com/manelmontilla/goa-cellar) repo contains the implementation for a
